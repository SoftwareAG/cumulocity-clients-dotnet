...
namespace Com.Cumulocity.Client.Api 
{
  ...
  {
    Task<Stream> AssignAsChildAddition(ChildOperationsAddOne body, string id);
    Task<Stream> AssignAsChildAddition(ChildOperationsAddMultiple body, string id);
    Task<Stream> AssignAsChildAddition(ManagedObject body, string id);
    Task<Stream> AssignAsChildAsset(ChildOperationsAddOne body, string id);
    Task<Stream> AssignAsChildAsset(ChildOperationsAddMultiple body, string id);
    Task<Stream> AssignAsChildAsset(ManagedObject body, string id);
    Task<Stream> AssignAsChildDevice(ChildOperationsAddOne body, string id);
    Task<Stream> AssignAsChildDevice(ChildOperationsAddMultiple body, string id);
    Task<Stream> AssignAsChildDevice(ManagedObject body, string id);
    ...
    Task<Stream> UnassignChildAddition(string id, string childId);
    Task<Stream> UnassignChildAdditions(ChildOperationsAddMultiple body, string id);
    Task<Stream> UnassignChildAsset(string id, string childId);
    Task<Stream> UnassignChildAssets(ChildOperationsAddMultiple body, string id);
    Task<Stream> UnassignChildDevice(string id, string childId);
    Task<Stream> UnassignChildDevices(ChildOperationsAddMultiple body, string id);
  }
