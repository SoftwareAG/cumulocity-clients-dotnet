...
namespace Com.Cumulocity.Client.Api
{
  ...
  {
    Task<TBody?> CreateManagedObject<TBody>(TBody body) where TBody : ManagedObject;
    Task<Stream> DeleteManagedObject(string id, bool? cascade = null, bool? forceCascade = null, bool? withDeviceUser = null);
    Task<DateTime> GetLatestAvailability(string id);
    Task<TResponse?> GetManagedObject<TResponse>(string id, bool? skipChildrenNames = null, bool? withChildren = null, bool? withChildrenCount = null, bool? withParents = null) where TResponse : ManagedObject;
    Task<ManagedObjectCollection<T>?> GetManagedObjects<T>(string? childAdditionId = null, string? childAssetId = null, string? childDeviceId = null, int? currentPage = null, string? fragmentType = null, List<string>? ids = null, bool? onlyRoots = null, string? owner = null, int? pageSize = null, string? q = null, string? query = null, bool? skipChildrenNames = null, string? text = null, string? type = null, bool? withChildren = null, bool? withChildrenCount = null, bool? withGroups = null, bool? withParents = null, bool? withTotalElements = null, bool? withTotalPages = null) where T : ManagedObject;
    ...
    Task<TBody?> UpdateManagedObject<TBody>(TBody body, string id) where TBody : ManagedObject;
