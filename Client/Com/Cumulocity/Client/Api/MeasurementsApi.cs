...
namespace Com.Cumulocity.Client.Api 
{
  public interface IMeasurementsApi
  {
    ...
    Task<Stream> DeleteMeasurement(string id);
    Task<Stream> DeleteMeasurements(DateTime? dateFrom = null, DateTime? dateTo = null, string? fragmentType = null, string? source = null, string? type = null);
    Task<Measurement?> GetMeasurement(string id);
    Task<MeasurementCollection?> GetMeasurements(int? currentPage = null, DateTime? dateFrom = null, DateTime? dateTo = null, int? pageSize = null, bool? revert = null, string? source = null, string? type = null, string? valueFragmentSeries = null, string? valueFragmentType = null, bool? withTotalElements = null, bool? withTotalPages = null);
    Task<MeasurementSeries?> GetMeasurementSeries(string? aggregationType = null, DateTime? dateFrom = null, DateTime? dateTo = null, bool? revert = null, List<string>? series = null, string? source = null);
  }
