///
/// CategoryOptionsJsonConverter.cs
		...
		public override T? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
		{
			...
			using (var jsonDocument = JsonDocument.ParseValue(ref reader))
			{
				...
				while (objectEnumerator.MoveNext())
				{
					...
					else if (CategoryOptions.Serialization.AdditionalPropertyClasses.ContainsKey(current.Name))
					{
						var type = CategoryOptions.Serialization.AdditionalPropertyClasses[current.Name];
