...
namespace Com.Cumulocity.Client.Model 
{
	...
	public class AuditRecord 
	{
		...
		private class JsonConverterAwareFragments : JsonConverter<AuditRecord>
		{
		
			public override AuditRecord? Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
			{
				var instance = Activator.CreateInstance(typeToConvert) as AuditRecord;
			...
			public override void Write(Utf8JsonWriter writer, AuditRecord value, JsonSerializerOptions options)
			{
