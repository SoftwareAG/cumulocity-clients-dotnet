...
namespace Com.Cumulocity.Client.Model 
{
	...
	public class Event 
	{
		...
		private class JsonConverterAwareFragments : JsonConverter<Event>
		{
		
			public override Event? Read(ref Utf8JsonReader reader, System.Type typeToConvert, JsonSerializerOptions options)
			{
				var instance = Activator.CreateInstance(typeToConvert) as Event;
