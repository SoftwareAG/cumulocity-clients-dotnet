...
public sealed class GroupReferenceCollection<TCustomProperties> where TCustomProperties : CustomProperties
{
	...
	/// <summary> 
	/// An array of group references. <br />
	/// </summary>
	///
