...
namespace Com.Cumulocity.Client.Model 
{
	public class ManagedObjectCollection<TManagedObject> where TManagedObject : ManagedObject
	{
		...
		/// <summary> 
		/// An array containing the results (managed objects) of the request. <br />
		/// </summary>
		///
		[JsonPropertyName("managedObjects")]
		public List<TManagedObject> ManagedObjects { get; set; } = new List<TManagedObject>();
