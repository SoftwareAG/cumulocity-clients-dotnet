...
public sealed class TenantCollection<TCustomProperties> where TCustomProperties : CustomProperties
{
	...
	/// <summary> 
	/// An array containing the results (subtenants) of the request. <br />
	/// </summary>
	///
